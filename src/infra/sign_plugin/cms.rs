...
#[cfg(test)]
const SM2_CRT: &str = include_str!("../../../test_assets/sm2_test_cert.pem");
#[cfg(test)]
const SM2_KEY: &str = include_str!("../../../test_assets/sm2_test_key.pem");
#[cfg(test)]
const RSA_CRT: &str = include_str!("../../../test_assets/rsa_test_cert.pem");
#[cfg(test)]
const RSA_KEY: &str = include_str!("../../../test_assets/rsa_test_key.pem");
